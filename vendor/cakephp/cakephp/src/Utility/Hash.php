...
class Hash
{
     ...
     * - `{n}.Users[id].name` Get the name of every user with an id key.
     * - `{n}.Users[id>=2].name` Get the name of every user with an id key greater than or equal to 2.
     * - `{n}.Users[username=/^paul/]` Get Users elements with username matching `^paul`.
     * - `{n}.Users[id=1].name` Get the Users name with id matching `1`.
     *
     ...
     *
     * ```
     * $result = Hash::format($users, ['{n}.Users.id', '{n}.Users.name'], '%s : %s');
     * ```
     *
