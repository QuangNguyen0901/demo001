...
class IntegrationTestCaseTest extends IntegrationTestCase
{
    ...
    public function testRequestBuilding()
    {
        ...
        $this->session(['Users' => ['id' => 1, 'username' => 'mark']]);
        ...
        $this->assertEquals(['id' => '1', 'username' => 'mark'], $request['session']->read('Users'));
    ...
    public function testRequestSetsProperties()
    {
        ...
        $this->assertContains('Template' . DS . 'Posts' . DS . 'users_list.ctp', $this->_viewName);
