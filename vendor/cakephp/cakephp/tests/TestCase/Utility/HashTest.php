...
class HashTest extends TestCase
{
    ...
    {
        $result = Hash::combine([], '{n}.Users.id', '{n}.Users.Data');
        $this->assertEmpty($result);
    ...
    {
        $data = [
            ['Users' => ['id' => 1, 'name' => 'mark']],
            ['Users' => ['name' => 'jose']],
        ];
        Hash::combine($data, '{n}.Users.id', '{n}.Users.name');
    }
    ...
    public function testCombineWithFormatting()
    {
        ...
        $result = Hash::combine(
            $a,
            '{n}.Users.id',
            ['%1$s: %2$s', '{n}.Users.Data.user', '{n}.Users.Data.name'],
            '{n}.Users.group_id'
        );
        $expected = [
            1 => [
        ...
        $result = Hash::combine(
            $a,
            ['%1$s: %2$d', '{n}.Users.Data.user', '{n}.Users.id'],
            '{n}.Users.Data.name'
        );
        $expected = [
        ...
        $result = Hash::combine(
            $a,
            ['%2$d: %1$s', '{n}.Users.Data.user', '{n}.Users.id'],
            '{n}.Users.Data.name'
        );
        $expected = [
            '2: mariano.iglesias' => 'Mariano Iglesias',
