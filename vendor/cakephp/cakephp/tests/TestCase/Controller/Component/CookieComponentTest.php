...
class CookieComponentTest extends TestCase
{
    ...
    {
        $this->Cookie->configKey('Users', 'expires', '+3 days');
        $result = $this->Cookie->configKey('Users');
        $expected = [
            'expires' => '+3 days',
            'path' => '/',
            'domain' => '',
    ...
    {
        $this->Cookie->write('Users', ['name' => 'mark'], false);
        $this->Cookie->write('Users.email', 'mark@example.com', false);
        $expected = [
            'name' => 'Users',
        ...
        $result = $this->Controller->response->cookie('Users');
        unset($result['expire']);
    ...
    {
        $this->request->cookies = [
            'Users' => ['email' => 'example@example.com', 'name' => 'mark'],
            'other' => 'value'
        ];
        $this->assertEquals('mark', $this->Cookie->read('Users.name'));
        ...
        $this->assertNull($this->Cookie->read('Users.name'));
