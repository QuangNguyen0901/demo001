...
class AuthComponentTest extends TestCase
{
    ...
    public function testIsAuthorizedMissingFile()
    {
        ...
        $this->Controller->Auth->isAuthorized(['Users' => ['id' => 1]]);
    }
    ...
    public function testIsAuthorizedDelegation()
    {
        ...
        $this->assertTrue($this->Auth->isAuthorized(['Users'], $request));
    ...
    {
        $this->assertEquals('Auth.Users', $this->Auth->sessionKey);
