...
class ViewTest extends TestCase
{
    ...
    public function testGetTemplate()
    {
        ...
        $expected = Plugin::path('TestTheme') . 'src' . DS . 'Template' . DS . 'Posts' . DS . 'users_list.ctp';
    ...
    public function testPluginGetTemplate()
    {
        ...
        $expected = Plugin::path('TestPlugin') . 'src' . DS . 'Template' . DS . 'Tests' . DS . 'users_list.ctp';
    ...
    public function testPluginGetTemplateAbsoluteFail()
    {
        ...
        $view = new TestView(null, null, null, $viewOptions);
        $expected = TEST_APP . 'Plugin' . DS . 'Company' . DS . 'TestPluginThree' . DS . 'src' . DS . 'Template' . DS . 'Pages' . DS . 'users_list.ctp';
    ...
    public function testPluginThemedGetTemplate()
    {
        ...
        $expected = $themePath . 'Plugin' . DS . 'TestPlugin' . DS . 'Tests' . DS . 'users_list.ctp';
    ...
    public function testCamelCasePluginGetTemplate()
    {
        ...
        $expected = TEST_APP . 'Plugin' . DS . 'TestPlugin' . DS . 'src' . DS .
            'Template' . DS . 'Tests' . DS . 'users_list.ctp';
        $result = $View->getViewFileName('index');
        $this->assertPathEquals($expected, $result);
    ...
    public function testGetViewFileNames()
    {
        ...
        $expected = TEST_APP . 'TestApp' . DS . 'Template' . DS . 'Posts' . DS . 'users_list.ctp';
    ...
    public function testViewFileName()
    {
        ...
        $result = $View->getViewFileName('index');
        $this->assertRegExp('/Posts(\/|\\\)users_list.ctp/', $result);
