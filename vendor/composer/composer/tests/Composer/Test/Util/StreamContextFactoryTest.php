...
class StreamContextFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function dataGetContext()
    {
        return array(
            array(
                $a = array('http' => array('follow_location' => 1, 'max_redirects' => 20, 'header' => array('Users-Agent: foo'))), array('http' => array('header' => 'Users-Agent: foo')),
                array('options' => $a), array(),
            ),
            array(
                $a = array('http' => array('method' => 'GET', 'max_redirects' => 20, 'follow_location' => 1, 'header' => array('Users-Agent: foo'))), array('http' => array('method' => 'GET', 'header' => 'Users-Agent: foo')),
    ...
    public function testHttpProxy()
    {
        ...
        $context = StreamContextFactory::getContext('http://example.org', array('http' => array('method' => 'GET', 'header' => 'Users-Agent: foo')));
        $options = stream_context_get_options($context);
        ...
        $this->assertEquals(array('http' => array(
            ...
            'method' => 'GET',
            'header' => array('Users-Agent: foo', "Proxy-Authorization: Basic " . base64_encode('username:p@ssword')),
            'max_redirects' => 20,
            'follow_location' => 1,
        )), $options);
    }
    ...
    public function testOptionsArePreserved()
    {
        ...
        $context = StreamContextFactory::getContext('http://example.org', array('http' => array('method' => 'GET', 'header' => array('Users-Agent: foo', "X-Foo: bar"), 'request_fulluri' => false)));
        $options = stream_context_get_options($context);
        ...
        $this->assertEquals(array('http' => array(
            ...
            'method' => 'GET',
            'header' => array('Users-Agent: foo', "X-Foo: bar", "Proxy-Authorization: Basic " . base64_encode('username:password')),
            'max_redirects' => 20,
            'follow_location' => 1,
        )), $options);
    }
    ...
    public function testHttpProxyWithoutPort()
    {
        ...
        $context = StreamContextFactory::getContext('https://example.org', array('http' => array('method' => 'GET', 'header' => 'Users-Agent: foo')));
        $options = stream_context_get_options($context);
        ...
        $expected = array(
            'http' => array(
                ...
                'request_fulluri' => true,
                'method' => 'GET',
                'header' => array('Users-Agent: foo', "Proxy-Authorization: Basic " . base64_encode('username:password')),
                'max_redirects' => 20,
                'follow_location' => 1,
            ), 'ssl' => array(
                'SNI_enabled' => true,
    ...
    public function testSSLProxy($expected, $proxy)
    {
        ...
        if (extension_loaded('openssl')) {
            $context = StreamContextFactory::getContext('http://example.org', array('http' => array('header' => 'Users-Agent: foo')));
            $options = stream_context_get_options($context);
